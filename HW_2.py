...
print('result_mp_s_roote = ', result_mp_s_root)
#  19. Присвоить переменной item_1 odd значение
item_1 = 9
print ('item_1 odd значение = ', item_1)
# 20. Присвоить переменной item_2 even значение
item_2 = 12
print('item_2 even значение = ', item_2)
...
result_int = int(math.ceil(result_division))
